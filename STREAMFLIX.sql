...
SELECT title, price FROM movies WHERE price > 150;
SELECT title, price FROM movies WHERE price > 150;
SELECT title, language FROM movies WHERE language = 'Hindi';
SELECT title, views FROM movies WHERE views = 1000000;
SELECT title, release_year FROM movies WHERE release_year > 2015;
SELECT title, rating FROM movies WHERE rating BETWEEN 8 AND 8.5;
SELECT title, genre FROM movies WHERE genre IN('Action', 'Comedy', 'Thriller');
SELECT title, director FROM movies WHERE director = 'S. S. Rajamouli';
SELECT title, production_company FROM movies WHERE production_company = 'Hombale Films';
SELECT title, production_company FROM movies WHERE production_company = 'Arka Media Works';
...
SELECT * FROM movies WHERE LENGTH(title) = 5;
SELECT director FROM movies WHERE director like '%Raj%';
SELECT production_company FROM movies WHERE production_company like '%Films%';
...
SELECT * FROM movies WHERE rating > 8 AND views > 500000 AND price BETWEEN 100 AND 250 ORDER BY views DESC LIMIT 5;
